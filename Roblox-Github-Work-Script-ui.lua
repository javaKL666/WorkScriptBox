...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://133505315200130" --脚本菜单背景图
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://118608237136042"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://89124530991050" or "rbxassetid://73509329415731" --开关的图
end)
      ...
      function window.Tab(window, name, icon)
        ...
        function section:Label(text)
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            ToggleModule.BackgroundColor3 = ALcolor
